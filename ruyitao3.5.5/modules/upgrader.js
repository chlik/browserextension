...
(function(S, undefined) {
    S.upgrader = {
         ...
         *     - install: callback function when first run
         *     - after: callback function when after upgrading
        ...
        run: function ( old_version, new_version, settings ) {
            ...
            if ( this.version_compare(old_version, 0) == 0 ) {
                ...
                } else if ( typeof upgrades["0"] == "function" ) {
                    upgrades["0"](old_version, new_version);
                }
            } else {
            ...
            if ( this.version_compare(old_version, new_version) != 0 && settings.after ) {
